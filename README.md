...
- Increased HAD40 structure damage by 5 to make it scale better as an upgrade from the HAG30 compared to the upgrade from the HAG20 to the HAG30
...
- Small X Pulse Laser (and upgrade + and ++) - as with all x pulses, it has a longer range than normal pulse, but shorter than clan and similar damage
...
- Magshot (and upgrades) - Inner Sphere version of AP Gauss, longer ranged but bulkier and slightly less damage.
- Hyper Gauss Rifle - Not the same thing as a Hyper Assault Gauss, this is a Clan/Draconis Combine designed version of the Heavy Gauss Rifle made with Clan-Tech. Much higher damage but shorter range than regular Heavy Gauss
...
- RISC Hyper Laser - The production ready version of the prototype, so it generates somewhat less heat at 72 instead of the 96 that the table top version would generate, but still very heavy relative to its damage and heat
